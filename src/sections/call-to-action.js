      ...
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            <Text as="span">Por trás do Projecto</Text>
            <Heading as="h3">
              Tecnologias que usamos para desenvolver o sistema
            </Heading>
            <Text as="p">
              As tecnologias que foram escolhidas: Amazon Web Services, NextJs, Laravel, Git (CI/CD), Figma, PostgreSQL.
            </Text>
            <Link path="https://us11.list-manage.com/contact-form?u=347a65258b878659feca3586f&form_id=1310836092ff6469ecd9fe35a45d3bbe" sx={styles.button}>
              Contrate-Nos
            </Link>
          </Box>
