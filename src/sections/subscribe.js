...
const Subscribe = () => {
  ...
  return (
    <Box as="section" sx={styles.subscribe}>
      <Container>
        <Heading as="h3">Inscreva-se para ser notificado sobre os nossos serviços e produtos</Heading>
        <Text as="p">
          Ao se inscrever com seu e-mail, você aceitará nossa política de privacidade
        </Text>
        <Box as="form" sx={styles.form}>
          ...
          <Input
            placeholder="Introduza o teu email"
            type="email"
            id="subscribeEmail"
            sx={styles.input}
